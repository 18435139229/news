...
'cookie_pre' => 'HsDDW_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://127.0.0.1/xinwen/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://127.0.0.1/xinwen/statics/js/', //CDN JS
'css_path' => 'http://127.0.0.1/xinwen/statics/css/', //CDN CSS
'img_path' => 'http://127.0.0.1/xinwen/statics/images/', //CDN img
'app_path' => 'http://127.0.0.1/xinwen/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'tV61f0SpM2ZzKQ6D0t5G', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://127.0.0.1/xinwen/phpsso_server',	//接口地址
'phpsso_auth_key' => 'AghZ8iEMzR9ryYc5Nmv5gZ7bu6IQu4eo', //加密密钥
